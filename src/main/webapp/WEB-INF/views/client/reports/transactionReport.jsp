...
<head>
    ...
    <script type="text/javascript">
        this.globalUrl = '/client/report/transaction';
        this.globalSpan = '${span}';
        this.globalstat = '${stat}';
    ...
    <div class="page-content">
        <div class="content">
            <div class="page-title">
                <h3>Reports - <span class="semi-bold">Transactions</span></h3>
            </div>
            <div class="row-fluid">
                <div class="span12">
                        ...
                        <div class="grid-title">
                            ...
                            <div class="tools hidden-xs">
                                ...
                                <select name="searchTypeInput" id="searchTypeInput" onchange="changeSearchType();">
                                    ...
                                    <option value="4"<c:if test="${searchType == '4'}"> SELECTED</c:if>>In Phone</option>
                                    <option value="5"<c:if test="${searchType == '5'}"> SELECTED</c:if>>In Email</option>
                        ...
                        <div class="grid-body">
                            <table class="table table-striped" >
                                ...
                                <tr>
                                    ...
                                    <th><a href="javascript:void(0);" onclick="changeSort(4);">Phone</a></th>
                                    <th><a href="javascript:void(0);" onclick="changeSort(5);">Email</a></th>
                                    <th><a href="javascript:void(0);" onclick="changeSort(6);">Destination</a></th>
                                    <th><a href="javascript:void(0);" onclick="changeSort(7);">Order Value</a></th>
                                    <th><a href="javascript:void(0);" onclick="changeSort(8);">Status</a></th>
                                </tr>
                                </thead>
                                <tbody>
                                <c:forEach var="clientReportItemObject" items="${clientReportItemObjects}">
                                    <tr>
                                        ...
                                        <td><c:out value="${clientReportItemObject.customerPhone}" /></td>
                                        <td><c:out value="${clientReportItemObject.customerEmail}" /></td>
                                        <td><c:out value="${clientReportItemObject.destination}" /></td>
                                        <td><c:out value="${clientReportItemObject.orderValue}" /></td>
                                        <td><c:out value="${clientReportItemObject.transactionStateName}" /></td>
                                    </tr>
                                </c:forEach>
                                </tbody>
                            </table>
