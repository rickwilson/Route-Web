...
public class ShippingTracking {
    ...
    public static enum ShippingTrackingState {WAITING_FOR_TRACKING_NUMBER, READY_TO_POST_TRACKING, ACTIVE, COMPLETE, FAILED, TRYING_NEW_SLUG};
    ...
    private ShippingTrackingState shippingTrackingState = ShippingTrackingState.COMPLETE;
    ...
    public ShippingTracking(long transactionId, long accountId, String orderID, boolean shippingNotifications,
                            String notificationEmail) {
        this.transactionId = transactionId;
        this.accountId = accountId;
        this.orderID = orderID;
        this.shippingTrackingState = ShippingTrackingState.WAITING_FOR_TRACKING_NUMBER;
    ...
    public ShippingTracking(long transactionId, long accountId, String orderID, boolean shippingNotifications,
                            String notificationSms, String notificationEmail) {
        this.transactionId = transactionId;
        this.accountId = accountId;
        this.orderID = orderID;
        this.shippingTrackingState = ShippingTrackingState.WAITING_FOR_TRACKING_NUMBER;
    ...
    public ShippingTrackingState getShippingTrackingState() {
        return shippingTrackingState;
    }

    public void setShippingTrackingState(ShippingTrackingState shippingTrackingState) {
