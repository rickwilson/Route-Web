...
public class ShippingTrackingDetail {
    ...
    public ShippingTrackingDetail() {
    }

    public ShippingTrackingDetail(long shippingTrackingId, long accountId, String createdAt, String checkpointTime, String city, ISO3Country countryISO3, String countryName, String message, String state, String tag, String zip, String location) {
