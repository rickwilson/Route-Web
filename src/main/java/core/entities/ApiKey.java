...
public class ApiKey {
    ...
    // LIVE public widget key (starts with LIVE_wk_)
    private String widgetKey;

    // LIVE private api key (starts with LIVE_ak_)
    @NotNull
    @Column(nullable = false)
    private String apiKey;

    // LIVE private secret (starts with LIVE_s_)
    private String secret;

    // test public widget key (starts with test_wk_)
    private String testWidgetKey;

    // test private api key (starts with test_ak_)
    private String testApiKey;

    // test private secret (starts with test_s_)
