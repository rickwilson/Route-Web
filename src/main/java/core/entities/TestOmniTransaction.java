...
@Entity
public class TestOmniTransaction {
    @Id
    ...
    @NotNull
    @Column(nullable = false)
    private SourceEntity testSourceEntity;

    private long testSourceEntityId;
    ...
    public SourceEntity getTestSourceEntity() {
        return testSourceEntity;
    }

    public void setTestSourceEntity(SourceEntity testSourceEntity) {
        this.testSourceEntity = testSourceEntity;
    }

    public long getTestSourceEntityId() {
        return testSourceEntityId;
    }

    public void setTestSourceEntityId(long testSourceEntityId) {
        this.testSourceEntityId = testSourceEntityId;
    }
